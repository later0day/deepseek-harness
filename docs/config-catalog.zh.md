...
来源：[`packages/llm/llm-cc/src/index.ts:88`](../packages/llm/llm-cc/src/index.ts)
...
- `@deepseek-ai/dsh-credentials-keypool`（[`packages/credentials/keypool/src/index.ts`](../packages/credentials/keypool/src/index.ts)）
