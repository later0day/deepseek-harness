...
export const en = {
  ...
  poolLabel: 'Key pool',
  poolPolicyRoundRobin: 'Round-robin',
  poolPolicyManual: 'Manual',
  poolMemberConfigured: 'configured',
  poolMemberMissing: 'missing',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  poolLabel: '密钥池',
  poolPolicyRoundRobin: '轮换',
  poolPolicyManual: '手动',
  poolMemberConfigured: '已配置',
  poolMemberMissing: '缺失',
